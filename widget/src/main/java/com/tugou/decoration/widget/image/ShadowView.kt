...
class ShadowView @JvmOverloads constructor(
    ...
    init {
        ...
        constantShadowTranslationY = a.getDimension(R.styleable.ShadowView_constantShadowTranslationY,
                constantShadowTranslationY)
        variableShadowTranslationY = a.getDimension(R.styleable.ShadowView_variableShadowTranslationY,
                variableShadowTranslationY)
        scaleDown = a.getFloat(R.styleable.ShadowView_scaleDown, scaleDown).coerceIn(0f, 1f)
        bigBlurRadius = a.getFloat(R.styleable.ShadowView_bigBlurRadius, bigBlurRadius)
                .coerceIn(0f, 25f)
        padding = bigBlurRadius.toInt()
        smallBlurRadius = a.getFloat(R.styleable.ShadowView_smallBlurRadius, smallBlurRadius)
                .coerceIn(0f, 25f)
        a.recycle()
    }
